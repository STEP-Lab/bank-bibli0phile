...
public class AccountTest {
  ...
  public void checkCreditTransaction() throws MinimumBalanceException {
    ...
    assertThat(account.getAllTransactions(),hasItem(new CreditTransaction(new Date(),10000,new AccountNumber("1234-4567"),13000)));
  }
  
  @Test
  public void checkDebitTransaction() throws MinimumBalanceException {
    account.debit(1000);
    assertThat(account.getAllTransactions(),hasItem(new DebitTransaction(new Date(),1000,new AccountNumber("1234-4567"),2000)));
  }
}
